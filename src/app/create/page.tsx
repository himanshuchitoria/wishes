...
export default function ImmersiveWishStudio() {
  ...
  return (
    <div className={`min-h-screen w-full relative transition-colors duration-700 ${styles.bg}`}>
      ...
      <div className="w-full max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 pt-24 sm:pt-28 pb-8 h-full min-h-[calc(100vh-80px)] flex flex-col lg:flex-row gap-12 lg:gap-8 items-start relative z-10">
