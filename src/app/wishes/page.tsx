...
export default function WishQueuePage() {
  ...
  return (
    <div className="min-h-screen bg-rose-500 text-black w-full relative overflow-hidden font-sans pb-24">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20 pt-24 sm:pt-28">
